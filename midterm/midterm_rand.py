...
def optimal_coin_dispersion2(change, coin_denominations, p1, p2):
    ...
    cost2go = 2*NUM_ROUNDS*np.ones((NUM_ROUNDS, change+3))
...
number_coins = optimal_coin_dispersion2(change, coin_denominations, 0, 0)
print(number_coins)

change = 135
coin_denominations = np.array([1,7,11,32,63], dtype=np.int)
number_coins = optimal_coin_dispersion2(change, coin_denominations, 0.1, 0.05)
print(number_coins)


change = 135
coin_denominations = np.array([1,7,11,32,63, 100], dtype=np.int)
number_coins = optimal_coin_dispersion2(change, coin_denominations, 0.08, 0.05)
print(number_coins)
...
for x2 in range(2, 15):
    print('x2:', x2)
    for x3 in range(10, 50):
        for x4 in range(25, 99):
            if x3 == x4 or x2 == x4:
                continue
